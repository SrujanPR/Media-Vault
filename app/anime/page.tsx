...
export default function AnimePage() {
  ...
  const allItems = useMemo(() => [...animeData.completed, ...animeData.currentlyWatching], [])
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-balance">
            Track your anime journey with completed series and current watchlist
          </p>
        </div>
        ...
        {query ? (
          ...
          <div className="space-y-12">
            <MediaSection title="Completed" items={animeData.completed} />
            <MediaSection title="Currently Watching" items={animeData.currentlyWatching} />
          </div>
        )}
      </main>
    </div>
